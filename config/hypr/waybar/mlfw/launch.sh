...
if [ ! -f ~/.config/hypr/waybar/mlfw/themes${arrThemes[1]}/style.css ]; then
...
if [ -f ~/.config/hypr/waybar/mlfw/themes${arrThemes[0]}/config-custom ]; then
    config_file="config-custom"
fi
if [ -f ~/.config/hypr/waybar/mlfw/themes${arrThemes[1]}/style-custom.css ]; then
    style_file="style-custom.css"
fi

# Check if waybar-disabled file exists
if [ ! -f $HOME/.config/ml4w/settings/waybar-disabled ]; then
    waybar -c ~/.config/hypr/waybar/mlfw/themes${arrThemes[0]}/$config_file -s ~/.config/hypr/waybar/mlfw/themes${arrThemes[1]}/$style_file &
else
